...
public class CoreBlocks {
    ...
    public static final BlockEntityType<RuneAltarEntity> RUNE_ALTAR_ENTITY = Registry.register(
            Registry.BLOCK_ENTITY_TYPE,
            new Identifier(ModID, "rune_altar_entity"),
            FabricBlockEntityTypeBuilder.create(RuneAltarEntity::new, RUNE_ALTAR).build()
    );
