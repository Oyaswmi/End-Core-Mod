package com.oyaswmi.endcore.packets;
...
public class EndSnowballSpawn {
    static Identifier PacketID = new Identifier(ModID, "throw_snowball");
    public static Packet<?> create(Entity e, Identifier packetID) {
        if (e.world.isClient)
            throw new IllegalStateException("EndSnowballSpawn called on the logical client!");
